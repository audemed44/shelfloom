...
/**
 * Deferred tag picker — collects tag selections without making API calls
 * to assign them to a book. Tags are created via API if they don't exist,
 * but assignment is the caller's responsibility.
 */
